    ...
    <div className="max-w-6xl mx-auto space-y-6">
      ...
      {viewMode === "FORM" ? (
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white dark:bg-zinc-900 rounded-lg p-5 border border-slate-200/80 dark:border-zinc-800 shadow-2xs flex items-center gap-4">
            <div className="w-12 h-12 rounded-md bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 flex items-center justify-center font-bold shrink-0">
              <Users size={24} />
            </div>
          ...
          <div className="bg-white dark:bg-zinc-900 rounded-lg p-6 border border-slate-200/80 dark:border-zinc-800 shadow-xs space-y-8">
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 gap-4">
                ...
                <div>
                  ...
                  <textarea
                    className="w-full bg-white dark:bg-zinc-900 border-2 border-slate-100 dark:border-zinc-800 rounded-md px-4 py-3 text-sm text-slate-900 dark:text-white focus:border-emerald-500 focus:outline-none transition-all resize-none h-24"
            ...
            {editingGroup && (
              <div className="border-t border-slate-200 dark:border-zinc-800 pt-6 space-y-6">
                ...
                {groupDetailsLoading ? (
                  ...
                  <>
                    {/* Add Member Form */}
                    <div className="bg-slate-50 dark:bg-zinc-800/40 p-4 rounded-md border border-slate-200/70 dark:border-zinc-800 space-y-3">
                      ...
                      <div className="flex gap-2">
                        <button
                          ...
                          className={`flex-1 px-3 py-2 text-xs font-bold rounded-sm border transition-all ${
                    ...
                    {(() => {
                      ...
                      if (membersList.length === 0) {
                        return (
                          <p className="text-sm text-slate-500 dark:text-zinc-500 italic p-6 text-center bg-slate-50 dark:bg-zinc-900/40 rounded-md border border-dashed border-slate-200 dark:border-zinc-800">
                        ...
                        <div className="space-y-2.5">
                          {membersList.map((member) => {
                            ...
                            return (
                              <div
                                key={key}
                                className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 p-3.5 bg-white dark:bg-zinc-900 rounded-md border border-slate-200/80 dark:border-zinc-800 hover:border-slate-300 transition-all shadow-2xs"
                              >
                                <div className="flex items-start justify-between gap-3 min-w-0 flex-1 w-full">
                                  <div className="flex items-start gap-3 min-w-0 flex-1">
                                    <div
                                      className={`w-9 h-9 rounded-sm flex items-center justify-center font-bold text-sm shrink-0 mt-0.5 ${
