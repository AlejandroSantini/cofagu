...
export const YardPage: React.FC = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-6">
      ...
      >
        <div className="space-y-4 pt-2">
          ...
          <div>
            ...
            <textarea
              className="w-full bg-white dark:bg-zinc-900 border-2 border-slate-100 dark:border-zinc-800 rounded-xl px-4 py-3 text-sm text-slate-900 dark:text-white focus:border-rose-500 focus:outline-none transition-all resize-none h-28"
      ...
      {/* Error display */}
      {error && (
        <div className="bg-rose-50 dark:bg-rose-950/20 border border-rose-200 dark:border-rose-900/40 text-rose-700 dark:text-rose-300 text-sm font-medium p-4 rounded-xl">
          {error}
        </div>
      )}
