  ...
  return (
    <div className="space-y-6">
      ...
      {showCreateForm && isCarrier && (
        <div className="bg-white dark:bg-zinc-900 p-6 rounded-md border border-slate-200 dark:border-zinc-800 shadow-sm space-y-6">
          ...
          <form onSubmit={handleSubmitInvoice} className="space-y-6">
            {error && (
              <div className="p-4 bg-rose-50 dark:bg-rose-950/20 text-rose-600 rounded-md border border-rose-100 dark:border-rose-900/30 text-sm font-semibold">
                {error}
              </div>
            )}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-4">
                ...
                <div className="p-4 bg-slate-50 dark:bg-zinc-850/50 rounded-md border border-slate-200/50 dark:border-zinc-800">
      ...
      {isCarrier && completedLoads.length > 0 && (
        <div className="bg-white dark:bg-zinc-900 rounded-md border border-slate-200 dark:border-zinc-800 shadow-sm p-6 space-y-4">
            ...
            {selectedInvoice.invoicePhotoUrl && (
              <div className="pt-2">
                <a 
                  ...
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 px-4 py-2 bg-emerald-50 text-emerald-600 dark:bg-emerald-900/30 dark:text-emerald-400 font-bold rounded-sm hover:bg-emerald-100 transition-colors"
                >
