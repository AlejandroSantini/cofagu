      ...
      <form onSubmit={handleSubmit(handleFormSubmit)} className="space-y-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="md:col-span-2">
            ...
            <textarea
              className="w-full bg-white dark:bg-zinc-900 border-2 rounded-md px-4 py-3 text-sm text-slate-900 dark:text-white border-slate-100 dark:border-zinc-800 focus:border-emerald-500 focus:outline-none transition-all resize-none h-24"
              ...
              <div className="flex flex-col gap-3">
                {groups.map((group) => {
                  ...
                  return (
                    <div
                      key={group.id}
                      className={`flex flex-col sm:flex-row sm:items-center justify-between p-4 rounded-md border transition-all ${
                        groupState.checked
                        ...
                        <div className="mt-4 sm:mt-0 sm:ml-4 sm:w-1/3 shrink-0">
                          <div className="relative">
                            ...
                            <input
                              ...
                              className={`w-full bg-slate-50 dark:bg-zinc-800/60 border rounded-sm pl-7 pr-3 py-1.5 text-sm text-slate-800 dark:text-white font-medium focus:ring-2 focus:outline-none transition-all ${
                                errorMsg
